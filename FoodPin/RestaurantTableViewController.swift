...
class RestaurantTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) ->
        ...
        let CellIdentifier = "Cell"
            // Only ass as! Keyword after creating the data model for the custom TableViewCell 
            
        let Cell = tableView.dequeueReusableCell(withIdentifier: CellIdentifier, for: indexPath) as! RestaurantTableViewCell
            // What happened is the previous line of coding is downcasting
            //It is converting the dequeReusableCell type to our new data  model type 
            // as! vs as? --- use whe------ la bala bal aa
